...
Another one, we might not even need to replace our hooking method for supporting developer console injection, we could be able to do:
...
- Remove the Miniblox main script, and then re-add it. (probably will spam errors, 30%. might work)
