 ...
 */
export default function lookAt(dx: number, dy: number, dz: number, distance: number) {
	...
	let yaw = MathHelper.wrapAngleTo180(targetYaw /* + this.aimNoiseYaw - this.rotationYaw*/);
