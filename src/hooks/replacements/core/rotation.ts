...
export const ROTATION_REPLACEMENTS: MultipleReplacements = [
	[
		"this.yaw-this.",
		{
			replacement: `(${ACTIVE_YAW} ?? this.yaw) - this.`,
			shift: Shift.REPLACE,
		},
	],
	[
		"x.yaw=player.yaw",
		{
			replacement: `x.yaw = ${ACTIVE_YAW} ?? this.yaw`,
			shift: Shift.REPLACE,
		},
	],
	[
		...
		{
			replacement: `=(${ACTIVE_YAW} ?? this.yaw),this.lastReportedPitch=`,
			shift: Shift.REPLACE,
		},
	],
	[
		...
		{
			replacement: `this.neck.rotation.y=(${ACTIVE_YAW} ?? this.yaw)`,
			shift: Shift.REPLACE,
		},
	],
	[
		"yaw:this.yaw",
		{
			replacement: `yaw:(${ACTIVE_YAW} ?? this.yaw)`,
			shift: Shift.REPLACE,
		},
	],
