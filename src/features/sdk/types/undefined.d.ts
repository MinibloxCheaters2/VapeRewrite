/**
 * Contains types which are just an alias to `unknown`.
 * Each type is here either because they aren't important (i.e. only useful server-sided) or I haven't gotten around to making types for them yet.
 */
//#region Needs Typings
//#region Required
